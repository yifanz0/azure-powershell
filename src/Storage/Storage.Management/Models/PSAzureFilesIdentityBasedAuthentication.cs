...
namespace Microsoft.Azure.Commands.Management.Storage.Models
{
    ...
    {
        public PSAzureFilesIdentityBasedAuthentication(global::Azure.ResourceManager.Storage.Models.AzureFilesIdentityBasedAuthentication auth)
        {
            if (auth != null)
            {
    ...
    {
        public PSActiveDirectoryProperties(global::Azure.ResourceManager.Storage.Models.ActiveDirectoryProperties properties)
        {
            if (properties != null)
            {

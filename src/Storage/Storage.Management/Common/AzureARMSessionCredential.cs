...
namespace Microsoft.WindowsAzure.Commands.Storage.Common
{
    ...
    public class AzureARMSessionCredential : TokenCredential
    {
        public AzureARMSessionCredential(IAzureContext DefaultContext, DebugLogWriter logWriter = null)
        {
            if (DefaultContext == null || DefaultContext.Account == null)
            {
                throw new InvalidOperationException("ContextCannotBeNull");
            }
            if (logWriter != null)
            {
        ...
        /// </summary>
        public const string StorageOAuthEndpointResourceValue = "https://management.core.windows.net";
